...
CONTAINS 
  ...
  SUBROUTINE PRINT_CONFIGURATION(SELF, KDEPTH, KOUTNO)
    ...
    IF (LHOOK) CALL DR_HOOK('YOMDYN:PRINT_CONFIGURATION',0,ZHOOK_HANDLE)
    IDEPTHLOC = KDEPTH+2
    ...
    IF (ALLOCATED(SELF%RSAVEDP)) THEN
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RSAVEDP allocated of shape ', SHAPE( SELF%RSAVEDP )
    ELSE
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RSAVEDP not allocated '
    ENDIF
    ...
    WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'SLHD_P_LOW = ', SELF%SLHD_P_LOW
    WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'SLHD_P_HIGH = ', SELF%SLHD_P_HIGH
    ...
    WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'SIPRA = ', SELF%SIPRA
    ...
    WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'SISLP = ', SELF%SISLP
    WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'SITVAR = ', SELF%SITVAR
    WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'SIFRA = ', SELF%SIFRA
    WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'SIFRG = ', SELF%SIFRG
    ...
    WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'LSIDYN_VERBOSE =',SELF%LSIDYN_VERBOSE
    WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'NITERHELM = ', SELF%NITERHELM
    WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'NOPT_SITR = ', SELF%NOPT_SITR
    WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'NOPT_SIPR = ', SELF%NOPT_SIPR
    WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'NOPT_SISLP = ', SELF%NOPT_SISLP
    ...
    ENDIF
    !* parameters related to SIPRA ------------------------------------------------------
    IF (ALLOCATED(SELF%SIALPH_NH)) THEN
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'SIALPH_NH allocated of shape',SHAPE( SELF%SIALPH_NH )
    ELSE
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'SIALPH_NH not allocated '
    ENDIF
    IF (ALLOCATED(SELF%SILNPR_NH)) THEN
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'SILNPR_NH allocated of shape',SHAPE( SELF%SILNPR_NH )
    ELSE
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'SILNPR_NH not allocated '
    ENDIF
    IF (ALLOCATED(SELF%SIDELP_NH)) THEN
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'SIDELP_NH allocated of shape',SHAPE( SELF%SIDELP_NH )
    ELSE
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'SIDELP_NH not allocated '
    ENDIF
    IF (ALLOCATED(SELF%SIRDEL_NH)) THEN
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'SIRDEL_NH allocated of shape',SHAPE( SELF%SIRDEL_NH )
    ELSE
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'SIRDEL_NH not allocated '
    ENDIF
    IF (ALLOCATED(SELF%SITLAH_NH)) THEN
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'SITLAH_NH allocated of shape',SHAPE( SELF%SITLAH_NH )
    ELSE
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'SITLAH_NH not allocated '
    ENDIF
    IF (ALLOCATED(SELF%SITLAF_NH)) THEN
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'SITLAF_NH allocated of shape',SHAPE( SELF%SITLAF_NH )
    ELSE
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'SITLAF_NH not allocated '
    ENDIF
    IF (ALLOCATED(SELF%SIDPHI_NH)) THEN
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'SIDPHI_NH allocated of shape',SHAPE( SELF%SIDPHI_NH )
    ELSE
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'SIDPHI_NH not allocated '
    ENDIF
    !* parameters related to SISLP -------------------------------------------------------
    IF (ALLOCATED(SELF%SIWF2H)) THEN
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'SIWF2H allocated of shape',SHAPE( SELF%SIWF2H )
    ELSE
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'SIWF2H not allocated '
    ENDIF
    IF (ALLOCATED(SELF%SIWH2F)) THEN
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'SIWH2F allocated of shape',SHAPE( SELF%SIWH2F )
    ELSE
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'SIWH2F not allocated '
    ENDIF
    IF (ALLOCATED(SELF%SIGFL)) THEN
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'SIGFL allocated of shape',SHAPE(SELF%SIGFL )
    ELSE
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'SIGFL not allocated '
    ENDIF
    IF (ALLOCATED(SELF%SIGFM)) THEN
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'SIGFM allocated of shape',SHAPE(SELF%SIGFM )
    ELSE
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'SIGFM not allocated '
    ENDIF
    IF (ALLOCATED(SELF%SITFL)) THEN
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'SITFL allocated of shape',SHAPE(SELF%SITFL )
    ELSE
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'SITFL not allocated '
    ENDIF
    IF (ALLOCATED(SELF%SITFM)) THEN
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'SITFM allocated of shape',SHAPE(SELF%SITFM )
    ELSE
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'SITFM not allocated '
    ENDIF
    IF (ALLOCATED(SELF%SIGHL)) THEN
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'SIGHL allocated of shape',SHAPE(SELF%SIGHL )
    ELSE
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'SIGHL not allocated '
    ENDIF
    IF (ALLOCATED(SELF%SIGHM)) THEN
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'SIGHM allocated of shape',SHAPE(SELF%SIGHM )
    ELSE
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'SIGHM not allocated '
    ENDIF
    ...
    ENDIF
     IF (ALLOCATED(SELF%SIZA)) THEN
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'SIZA allocated of shape ',SHAPE(SELF%SIZA )
    ELSE
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'SIZA not allocated '
    ENDIF
    IF (ALLOCATED(SELF%SIZC)) THEN
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'SIZC allocated of shape ',SHAPE(SELF%SIZC )
    ELSE
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'SIZC not allocated '
    ENDIF
    IF (ALLOCATED(SELF%SIBQ)) THEN
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'SIBQ allocated of shape ',SHAPE( SELF%SIBQ )
    ELSE
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'SIBQ not allocated '
    ENDIF
    ...
    WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'SLOPE_MAX = ', SELF%SLOPE_MAX
    ...
    WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RINTOPT = ', SELF%RINTOPT
    WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RRINTOPT = ', SELF%RRINTOPT
    ...
    !* Upper boundary gw Rayleigh Friction 
    WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'NLEV_GWFRIC = ', SELF%NLEV_GWFRIC
    WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'LGWFRIC = ', SELF%LGWFRIC
    WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RGWFRIC_MAX = ', SELF%RGWFRIC_MAX
    WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RGWFRIC_PLM = ', SELF%RGWFRIC_PLM
    IF (ALLOCATED(SELF%RGWFRIC)) THEN
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RGWFRIC allocated of shape',SHAPE( SELF%RGWFRIC )
    ELSE
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RGWFRIC not allocated '
    ENDIF

    WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RESGP = ', SELF%RESGP
    WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RESGM = ', SELF%RESGM
   
    !* parameter linked to HY/QE to EE blending approach
    WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RNHQE_DELTAM    = ', SELF%RNHQE_DELTAM
    WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'LNHQE_SOLVER_GP = ',SELF%LNHQE_SOLVER_GP
    WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'LNHHY_SOLVER_GP = ',SELF%LNHHY_SOLVER_GP
    WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'LNHQE_SOLVER_SP = ',SELF%LNHQE_SOLVER_SP
    WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'LNHHY_SOLVER_SP = ',SELF%LNHHY_SOLVER_SP
    WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'LRESET_BLEND_SI = ',SELF%LRESET_BLEND_SI
    WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'NSTART_BLEND    = ',SELF%NSTART_BLEND
    WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'NSTOP_BLEND     = ', SELF%NSTOP_BLEND
    IF (ALLOCATED(SELF%RNHHY_DELTAM)) THEN
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RNHHY_DELTAM allocated of shape',SHAPE( SELF%RNHHY_DELTAM )
    ELSE
      WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RNHHY_DELTAM not allocated'
    ENDIF

    WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'CLAITRI_TYPE = ', SELF%CLAITRI_TYPE
    WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'CLAITRI_WENO_TYPE = ', SELF%CLAITRI_WENO_TYPE
    WRITE(KOUTNO,*) REPEAT(' ',IDEPTHLOC) // 'RGAMMA_WENO = ', SELF%RGAMMA_WENO

IF (LHOOK) CALL DR_HOOK('YOMDYN:PRINT_CONFIGURATION',1,ZHOOK_HANDLE)
