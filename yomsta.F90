...
SUBROUTINE ALLOCSTA(SELF,KLEV)
  ...
  ALLOCATE(SELF%STPREH(0:KLEV))
  ALLOCATE(SELF%STPRE(KLEV))
  ALLOCATE(SELF%STPHI(KLEV))
  ALLOCATE(SELF%STTEM(KLEV))
  ALLOCATE(SELF%STDEN(KLEV))
  ALLOCATE(SELF%STZ(KLEV))
  ALLOCATE(SELF%SVETAH(0:KLEV))
  ALLOCATE(SELF%SVETAF(KLEV))
END SUBROUTINE

SUBROUTINE DEALLOCSTA(SELF)
  CLASS(TSTA),INTENT(INOUT) :: SELF

  DEALLOCATE(SELF%STPREH)
  DEALLOCATE(SELF%STPRE)
  DEALLOCATE(SELF%STPHI)
  DEALLOCATE(SELF%STTEM)
  DEALLOCATE(SELF%STDEN)
  DEALLOCATE(SELF%STZ)
  DEALLOCATE(SELF%SVETAH)
  DEALLOCATE(SELF%SVETAF)
END SUBROUTINE
END MODULE YOMSTA
