SUBROUTINE SPCSIDG_PART1TOT (YDGEOMETRY, YDDYN, KSTA, KEND, PSDIVP,&
...
IF (LHOOK) CALL DR_HOOK('SPCSIDG_PART1TOT',0,ZHOOK_HANDLE)
...
ASSOCIATE(NSMAX=>YDDIM%NSMAX,NFLEVG=>YDDIMV%NFLEVG,&
        &SIHEGIND=>YDDYN%SIHEGIND,NPTRMF=>YDMP%NPTRMF,MYMS=>YDLAP%MYMS,NSPSTAF=>YDMP%NSPSTAF)
...
IF (LHOOK) CALL DR_HOOK('SPCSIDG_PART1TOT',1,ZHOOK_HANDLE)
END SUBROUTINE SPCSIDG_PART1TOT
