...
SUBROUTINE SAVE_TVFE (SELF, KLUN)
...
SUBROUTINE LOAD_TVFE (SELF, KLUN)
...
SUBROUTINE COPY_TVFE (SELF, LDCREATED, LDFIELDAPI)
...
SUBROUTINE WIPE_TVFE (SELF, LDDELETED, LDFIELDAPI)
