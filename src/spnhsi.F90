...
!$ACDC semiimplicit --openmptoparallel
...
WRITE (*, '("SPNHSI (DEBUT) ",E30.20)') PSPDIVG (3, 1)
...
WRITE (*, '("BEFORE SPCSIDG_PART1 ZSDIVP = ",E30.20)') ZSDIVP (1, 1)
STOP 1
...
WRITE (*, '("ZZSPDIVG (AVANT SPCSIDG_PART1) ",E30.20)') ZZSPDIVG (3, 1)
...
WRITE (*, '("ZZSPDIVG (SPCSIDG_PART1) ",E30.20)') ZZSPDIVG (3, 1)
  ELSE
...
WRITE (*, '("ZZSPDIVG (FIN) ",E30.20)') ZZSPDIVG (3, 1)
...
WRITE (*, '("SPNHSI (FIN) ",E30.20)') PSPDIVG (3, 1)
