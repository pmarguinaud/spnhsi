...
WRITE (*, '(" PSDIVP = ",E30.20)') PSDIVP (1, 1)
WRITE (*, *) __FILE__, __LINE__
WRITE (*, '(10E30.20)') PSDIVP (:, 1)
PRINT *
WRITE (*, '(10E30.20)') PSPDIVP (:, 1)
...
PRINT *,  __FILE__, __LINE__, " PRESENT (LDACC) = ", PRESENT (LDACC)
PRINT *,  __FILE__, __LINE__, " LLACC = ", LLACC
