...
LOGICAL             :: LDOHD
LOGICAL             :: LESIDG
REAL(KIND=JPRB)    , POINTER :: PLAPDI(:) 
REAL(KIND=JPRB)    , POINTER :: PLAPIN(:)
...
INTEGER(KIND=JPIM)           :: KSZNISNAX
INTEGER(KIND=JPIM) , POINTER :: NISNAX(:)
...
CALL YDCST%ACDC_SAVE (ILUN)
CALL YDGEOMETRY%ACDC_SAVE (ILUN)
CALL YDLDDH%ACDC_SAVE (ILUN)
CALL YDRIP%ACDC_SAVE (ILUN)
CALL YDDYN%ACDC_SAVE (ILUN)
CALL YDDYNA%ACDC_SAVE (ILUN)
...
CALL SAVE (ILUN, PLAPDI       , KLBOUND=LBOUND (PLAPDI       ))
CALL SAVE (ILUN, PLAPIN       , KLBOUND=LBOUND (PLAPIN       ))
...
CALL SAVE (ILUN, KSZNISNAX    )    
CALL SAVE (ILUN, NISNAX       , KLBOUND=LBOUND (NISNAX       ))
CALL SAVE (ILUN, PSPAUXG      , KLBOUND=LBOUND (PSPAUXG      ))  
...
CALL YDCST%ACDC_LOAD (ILUN)
CALL YDGEOMETRY%ACDC_LOAD (ILUN)
CALL YDLDDH%ACDC_LOAD ( ILUN)
CALL YDRIP%ACDC_LOAD (ILUN)
CALL YDDYN%ACDC_LOAD (ILUN)
CALL YDDYNA%ACDC_LOAD (ILUN)
...
CALL LOAD (ILUN, PLAPDI       )
CALL LOAD (ILUN, PLAPIN       )
...
CALL LOAD (ILUN, KSZNISNAX    )
CALL LOAD (ILUN, NISNAX       )
CALL LOAD (ILUN, PSPAUXG      )
