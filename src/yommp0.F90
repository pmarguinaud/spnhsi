...
!  lsync_slcom : true: activate a barrier at the beginning of  SL communications
!  LSYNC_POSTSLCOM2 : true: activate a barrier at the end of SL communications
...
!  lslondem_split: .false. default value for split method of sl mask update (model only)
...
!  LVECADIN   : CONTROL VECTOR/SCALAR FOR ADJOINT INTERPOLATION
...
!  LGPTOT_CAP  : .true. to cap LAM domain in gridpoint space to C+I + east part of the E-zone
