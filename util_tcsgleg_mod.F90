...
SUBROUTINE SAVE_TCSGLEG (SELF, KLUN)
...
SUBROUTINE LOAD_TCSGLEG (SELF, KLUN)
...
SUBROUTINE COPY_TCSGLEG (SELF, LDCREATED, LDFIELDAPI)
...
SUBROUTINE WIPE_TCSGLEG (SELF, LDDELETED, LDFIELDAPI)
